...
const data: SiteData = {
  ...
  description:
    "Nous travaillons actuellement 👨‍💻 d'arrache-pied pour vous offrir quelque chose d'exceptionnel, et nous sommes impatients de le partager avec vous 📅. Notre équipe met la touche finale à un nouveau projet 🚀 que vous allez adorer 😍.",
